...
function PasoHoras({ horas, setHoras }) {
  return (
    <div>
      <h2 className="font-display text-2xl text-slate-900 dark:text-white">Class hours</h2>
    ...
    <div>
      ...
      <div className="mt-8 flex justify-center">
        <a
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-[#25D366] px-8 py-3 text-base font-semibold text-white shadow-lg transition-transform hover:scale-105 hover:shadow-xl"
        >
