    ...
    return (
        <main className="bg-[#031015] min-h-screen selection:bg-[#ff9069]/30 selection:text-white">
            <SEO
                ...
                description="A high-intensity, 7-day itinerary for intermediate riders in Máncora. Shatter plateaus and master Northern Peru waves with daily coaching and video analysis."
