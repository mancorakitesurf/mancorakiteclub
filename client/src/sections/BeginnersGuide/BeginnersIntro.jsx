...
function BeginnersIntro() {
  const { t } = useI18n()
  const title = t("beginnersGuide.intro.title")
    ...
    <section className="bg-white py-16 sm:py-20 lg:py-28">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="relative h-[320px] w-full overflow-hidden rounded-3xl shadow-xl sm:h-[420px] lg:h-[520px]"
        >
          <img
            src={getImage("optimized/critical/community-hero-desktop.webp")}
            alt={t("beginnersGuide.intro.imageAlt")}
