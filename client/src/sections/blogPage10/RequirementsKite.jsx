    ...
    return (
        <section className="bg-[#05161b] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
            <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 sm:gap-10 lg:grid-cols-2 lg:gap-16">
                <div>
                    <h2 className="mb-6 text-2xl font-bold uppercase tracking-tighter italic leading-tight text-white sm:text-3xl md:text-4xl lg:text-5xl sm:mb-8">Rider Requirements</h2>
                    <p className="mb-6 text-sm font-light leading-relaxed text-[#9eaeb4] sm:text-base md:text-lg sm:mb-8">{req.description}</p>
                        ...
                        {req.items.map((item, i) => (
                            <div key={i} className="relative overflow-hidden rounded-2xl border border-white/5 bg-[#132930]/50 p-4 group sm:p-6">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="mb-1 text-lg font-bold uppercase tracking-tight text-white sm:text-xl">{item.title}</h4>
                                        <p className="text-sm leading-relaxed text-[#9eaeb4]">{item.desc}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
