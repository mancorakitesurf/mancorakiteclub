        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          <div ref={dropdownRef} className="relative">
            ...
            >
              ...
              <span
                className={`text-[10px] transition-transform duration-300 sm:text-xs ${isLangOpen ? 'rotate-180' : ''
                  }`}
              >
                v
              </span>
            ...
            <div
              className={`absolute right-0 mt-3 w-44 origin-top-right rounded-2xl border border-white/10 bg-background-dark/95 shadow-2xl backdrop-blur-xl transition-all duration-300 sm:w-48 ${isLangOpen
            ...
            >
              {languages.map((lang) => (
                <button
                  ...
                  className={`flex w-full items-center justify-between px-4 py-3 text-sm transition-all duration-200 ${currentLang === lang.code
